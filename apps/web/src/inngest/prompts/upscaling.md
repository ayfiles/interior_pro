...
Create a slightly more cinematic, atmospheric, elegant, luxurious mood using only realistic brightness contrast, deeper shadow structure, controlled highlights, natural light falloff, ambient occlusion, contact shadows, and material-accurate light behavior. The cinematic effect must come from luminance, shadow depth, highlight placement, and realistic global illumination only, and only slightly through color grading.
...
Natural daylight must enter from the same direction as in the reference image, softly diffused and realistic. Add subtle soft sunlight rays only if they naturally match the existing light direction. The image should feel brighter, deeper, and more dimensional while preserving the exact original reference colors. Add subtle visible light rays entering from outside through the existing windows or openings, strictly following the natural daylight direction already present in the reference image. The rays should be soft, elegant, realistic, and lightly volumetric, creating a cinematic premium atmosphere.

The light rays must feel natural and physically plausible, as if sunlight is gently passing through the room's existing air and architectural openings. They should softly reveal depth, highlight edges, and add dimensionality to the space while preserving all original reference colors, white balance, materials, and lighting relationships.

CONTRAST AND SHADOW DEPTH:
Add slightly stronger natural contrast and deeper shadow depth. Shadows should feel richer, more dimensional, and more spatially layered, with clearer separation between lit and shaded areas. Preserve texture and detail inside shadow areas. Do not crush blacks, do not make the room too dark. The light composition should make the room look like an actual photograph taken in the actual real room. No AI look.
...
OVERALL RESULT:
Ultra-realistic, elegant, cozy, cinematic premium interior photograph with slightly stronger contrast, deeper realistic shadows, refined highlight placement, soft sunlight, natural dimensionality, crisp floor structure, sharp stone detail, accurate kitchen surface finishes, tactile high-end materials, and physically believable light behavior while preserving the exact original reference colors only.

## Negative Prompt

new colors, changed colors, invented colors, altered palette, warm grading, cool grading, orange cast, yellow tint, blue tint, green tint, beige shift, altered white balance, changed saturation, oversaturation, desaturation, recolored furniture, altered wall color, altered floor color, changed wood tone, changed stone color, changed fabric color, new materials, redesigned room, changed geometry, changed camera angle, changed proportions, moved furniture, added furniture, removed furniture, changed decor, turned-off lights, removed lights, added lights, relocated lights, dimmed practical lights, overly dark room, lost shadow detail, flat lighting, fake CGI look, plastic materials, waxy surfaces, wet-looking matte surfaces, overly smooth materials, blurry floor, textureless floor, fake wood grain, smeared stone texture, generic marble pattern, low-resolution stone, low-resolution textures, unrealistic reflections, distorted furniture, warped screen, blurry details, AI-generated artifacts.
